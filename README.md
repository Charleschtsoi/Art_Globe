...
**[🚀 Try the Live Demo](https://art-globe.vercel.app/)**

**[📖 Portfolio case study](https://art-globe.vercel.app/about)** — architecture, skills matrix, and how it was built.

## Portfolio showcase

The live site includes a landing page (`/`), interactive globe (`/explore`), and a case-study page (`/about`) documenting the tech stack, data pipeline, and challenges solved. See [art-globe.vercel.app/about](https://art-globe.vercel.app/about).

Integration tests include a smoke test that verifies artworks load on `/explore` (`npm run test:integration`).
